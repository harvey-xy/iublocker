...
function noopMp4(seconds: number): Buffer {
  ...
  const esdsPayload = Buffer.from([
    0x03, 0x19, 0x00, 0x00, 0x00, 0x04, 0x11, 0x40, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
function surrogateSource(name: string, source: string): string {
  return `/* iuBlocker surrogate for ${name}. Generated by packages/scriptlets/scripts/gen-resources.ts. */
(function () {
  try {
    (${source})();
  } catch (ex) {
